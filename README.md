...
```sh
gcloud storage buckets create --location="$REGION" gs://test-bucket-1-wmx48c2
```
...
metadata:
  ...
  namespace: boost-global
  annotations:
    boost.bitpoke.io/display-name: "gs://test-bucket-1-wmx48c2 (project and site)"
spec:
  gcs:
    bucket: calins-playground-media-test-1
  ...
  # - userDefined: files will be saved in gs://test-bucket-1-wmx48c2/PREFIX/USER_DEFINED_PATH
